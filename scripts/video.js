...
document.getElementById("customModal").showModal();
  ...
  <figure class="h-[200px] relative">
    ...
    ${videos.others.posted_date?.length == 0 ? "" : `  <span class="absolute text-xs right-2 bottom-2 bg-black rounded text-white p-1">${getTimeString(videos.others.posted_date)}</span>`}
